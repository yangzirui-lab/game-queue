# Game Gallery Linux 容器部署脚本（WSL2）

Write-Host "=== Game Gallery Linux 容器部署脚本 ===" -ForegroundColor Green
...
# 4. 构建镜像
Write-Host "`n[4/6] 构建 Linux 容器镜像..." -ForegroundColor Cyan
